...
def append_block_lr_to_logs(block_lrs, logs, lr_scheduler, optimizer_type):
    ...
    train_util.append_lr_to_logs_with_names(logs, lr_scheduler, optimizer_type, names, optimizer)
            ...
            with accelerator.accumulate(*training_models):
                ...
                if not (args.fused_backward_pass or args.fused_optimizer_groups):
                    ...
                    if args.learning_rate != 0:
                     ...
                     # TE1, TE2 が学習対象ならこちらも
                        if args.train_text_encoder:
                            if args.learning_rate_te1 is not None and args.learning_rate_te1 != 0:
                                zclipper.step(text_encoder1)
                            if args.learning_rate_te2 is not None and args.learning_rate_te2 != 0:
                                zclipper.step(text_encoder2) 
